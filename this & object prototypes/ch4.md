...
Nós veremos que esses conceitos não mapeiam muito naturalmente com o mecaniso de objeto no JS e suas extensões (mixins, etc.). Muitos desenvolvedores JavaScript irão superar esses desafios.
